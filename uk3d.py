...
if __name__ == "__main__":
    ...
    pairagraph = True
    n_indices = None
    mh1, mh2, mhh, counts = deal_with_files.load_3d_flattened(NTag=NTag, pairagraph=pairagraph)
    ...
    zpred, variance = get_kriging_prediction_3d(
        NTag, mh1, mh2, mhh, counts, uk_kwargs, n_indices=n_indices, pairagraph=pairagraph)
